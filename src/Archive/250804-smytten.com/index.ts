...
(async () => {
  const sites = await extractLocalSitemapLinks('./src/tasks/250804-smytten.com/sitemap-shop-products.xml');
  ...
  renameMoveCsv('smytten.com');
  completeAndRunNext('250804-smytten.com');
})();
