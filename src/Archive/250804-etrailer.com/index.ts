...
(async () => {
  const sites = await extractLocalSitemapLinks('./src/tasks/250804-etrailer.com/sitemap-generic-multi-product-1.xml');
  ...
  renameMoveCsv('etrailer.com');
  completeAndRunNext('250804-etrailer.com');
})();
