...
(async () => {
  const sites = await extractLocalSitemapLinks('./src/tasks/250804-t-mobile.com/product-sitemap.xml');
  ...
  renameMoveCsv('t-mobile.com');
  completeAndRunNext('250804-t-mobile.com');
})();
