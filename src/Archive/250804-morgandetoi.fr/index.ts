...
(async () => {
  const sites = await extractLocalSitemapLinks('./src/tasks/250804-morgandetoi.fr/sitemap_0-product.xml');
  ...
  renameMoveCsv('morgandetoi.fr');
  completeAndRunNext('250804-morgandetoi.fr');
})();
